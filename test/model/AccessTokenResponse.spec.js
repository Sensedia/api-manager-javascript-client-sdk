...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagerPortal.AccessTokenResponse();
  });
  ...
  describe('AccessTokenResponse', function() {
    it('should create an instance of AccessTokenResponse', function() {
      ...
      //var instane = new ApiManagerPortal.AccessTokenResponse();
      //expect(instance).to.be.a(ApiManagerPortal.AccessTokenResponse);
    });
