...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagerPortal.ChangeLogBean();
  });
  ...
  describe('ChangeLogBean', function() {
    it('should create an instance of ChangeLogBean', function() {
      // uncomment below and update the code to test ChangeLogBean
      //var instane = new ApiManagerPortal.ChangeLogBean();
      //expect(instance).to.be.a(ApiManagerPortal.ChangeLogBean);
    });
