...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagerPortal.DeploymentSimpleBean();
  });
  ...
  describe('DeploymentSimpleBean', function() {
    it('should create an instance of DeploymentSimpleBean', function() {
      // uncomment below and update the code to test DeploymentSimpleBean
      //var instane = new ApiManagerPortal.DeploymentSimpleBean();
      //expect(instance).to.be.a(ApiManagerPortal.DeploymentSimpleBean);
    });
